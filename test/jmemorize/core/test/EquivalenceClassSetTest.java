...
public class EquivalenceClassSetTest extends TestCase {
 ...
 public void testAddAll() {
  EquivalenceClassSet newSet = new EquivalenceClassSet(mod3EqvSet
   .getComparator());
 ...
 public void internalTestLoopIteratorRemoveFromClass(int remVal,
  boolean expectedToReduceCycle,
