	...
	public void actionPerformed(ActionEvent ae)
	{
		try
		{
			...
			if(selTextBase == null || textLength < 1)
			{
				...
				{
					sbNew.append("<li></li>");
					insertHTML(parentEkit.getTextPane(), parentEkit.getHTMLDoc(), parentEkit.getTextPane().getCaretPosition(), sbNew.toString(), 0, 0, HTML.Tag.LI);
				}
				else
				{
					...
					insertHTML(parentEkit.getTextPane(), parentEkit.getHTMLDoc(), parentEkit.getTextPane().getCaretPosition(), sbNew.toString(), 0, 0, (sListType.equals("ol") ? HTML.Tag.OL : HTML.Tag.UL));
					if(true)
					{
