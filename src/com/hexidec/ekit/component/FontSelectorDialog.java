 ...
 public FontSelectorDialog(Frame parent, String title, boolean bModal,
  ...
  for (int i = 0; i < fonts.length; i++) {
   if (!fonts[i].equals("Dialog") && !fonts[i].equals("DialogInput")
    && !fonts[i].equals("Monospaced") && !fonts[i].equals("SansSerif")
  ...
  Object[] panelContents = {Translatrix.getTranslationString("FontSample"),
   jtpFontPreview, attribName, jcmbFontlist};
