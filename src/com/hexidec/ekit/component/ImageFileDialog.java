...
public class ImageFileDialog extends JDialog implements ActionListener {
 ...
 public ImageFileDialog(Frame parent, String imgDir, String[] imgExts,
  String imgDesc, String imgSrc, String title, boolean bModal) {
 ...
 public File browseForImage() {
  ...
  jImageDialog.setDialogTitle(Translatrix.getTranslationString(
   "ImageDialogTitle"));
