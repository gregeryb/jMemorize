...
public class SearchDialog extends JDialog {
 ...
 public SearchDialog(Frame parent, String title, boolean bModal,
  ...
  final JCheckBox jchkCase = new JCheckBox(Translatrix.getTranslationString(
   "SearchCaseSensitive"), bCaseSetting);
  final JCheckBox jchkTop = new JCheckBox(Translatrix.getTranslationString(
   "SearchStartAtTop"), bTopSetting);
  final JCheckBox jchkAll = new JCheckBox(Translatrix.getTranslationString(
   "SearchReplaceAll"), false);
  final Object[] buttonLabels = {Translatrix
   .getTranslationString("DialogAccept"), Translatrix.getTranslationString(
   "DialogCancel")};
  if (bIsReplace) {
