...
class Entities {
 ...
 static class PrimitiveEntityMap implements EntityMap {
  ...
  private final Map<Integer, Object> mapValueToName = new HashMap<>();
 ...
 static class LookupEntityMap extends PrimitiveEntityMap {
  ...
  /**
   * <p>
   * Returns the lookup table for this entity map. The lookup table is created
  ...
  * from calls to the {@link Writer#write(int)} methods.
  */
 private void doUnescape(Writer writer, String str, int firstAmp) throws
  IOException {
