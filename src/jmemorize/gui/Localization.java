...
public class Localization {
 ...
 /**
  * @return the string associated with key in the default or child bundle or an
  * empty string if no such string available.
  */
 ...
 /**
  * @return the string associated with given key1 or the string assoiated with
  * given key2 if no string is associated with key1 in the sub bundle or the
  * string associated with given key in the default bundle or a debug string
  * when no string is available for any of the two given keys.
  */
  ...
  * <tt>/resource/text/langs.txt</tt>. Every line holds a string that represents
  * the language (and optionally the country) code.
  *
 ...
 /**
  * Compares the machines default locale with all available translations. If the
  * default locale is available as translation the machines locale is returned.
  * Otherwise the english language locale is returned as default.
  */
