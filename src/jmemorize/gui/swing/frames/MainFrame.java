...
//            UIManager.setLookAndFeel(new MetalLookAndFeel());
 ...
 /**
  * @return the level of the currently shown deck. The deck with unlearned cards
  * has level 0.
  */
 public int getDeck() {
  return m_deck;
 ...
 /**
  * @param show <code>true</code> if the category tree is supposed to be shown.
 ...
 /**
  * Loads the lesson and sets it as currently loaded lesson. If there is already
  * a opened lesson, the user might be prompted to save that lesson before
  * opening the new lesson.
  *
  * @param file The path to the lesson. If <code>null</code> a file chooser is
  ...
  * operation. If this method return <code>false</code> the closing of jMemorize
  * was canceled.
  */
 ...
 /*
  * (non-Javadoc) @see jmemorize.core.Main.LearnSessionStartObserver
  */
 ...
 /**
  * Update the frame title. This should be called when a new lesson was loaded
  * or changed.
  */
