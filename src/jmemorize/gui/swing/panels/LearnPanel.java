...
public class LearnPanel extends JPanel implements SelectionProvider,
 ...
 /*
  * (non-Javadoc) @see jmemorize.core.LearnSessionObserver
  */
 public void sessionStarted(LearnSession session) {
  ...
  int sidesToTest = settings.getAmountToTest(true) + settings.getAmountToTest(
   false);
 ...
 private void updateProgressBars() {
  ...
  int amtLearned = m_currentCard.getLearnedAmount(true) + m_currentCard
   .getLearnedAmount(false);
