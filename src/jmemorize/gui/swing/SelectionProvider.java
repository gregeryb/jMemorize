...
public interface SelectionProvider {
  ...
  * provider changes. Note that the methods isn't fired when related cards are
  * changed.
  */
  ...
  * related cards are all cards that have been learned so far in this session).
  */
  ...
  *
  * @return the currently selected categories or <code>null</code> if there are
  * none.
  */
 ...
 /**
  * The list of selected cards must always also include the card that is given
  * by getSelectedCard if that card is not null.
  *
