...
public class RemoveAction extends AbstractAction2 implements SelectionObserver {
 ...
 /*
  * (non-Javadoc) @see java.awt.event.ActionListener#actionPerformed
  */
 public void actionPerformed(java.awt.event.ActionEvent e) {
  List<Card> selectedCards = m_selectionProvider.getSelectedCards();
  List<Category> selectedCategories = m_selectionProvider
 ...
 public void selectionChanged(SelectionProvider source) {
  ...
  setEnabled((source.getSelectedCards() != null && source.getSelectedCards()
   .size() > 0) || (source.getSelectedCategories() != null && !source
   .getSelectedCategories().contains(rootCategory)));
 }
