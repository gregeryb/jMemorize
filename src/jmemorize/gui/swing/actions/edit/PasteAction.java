...
public class PasteAction extends AbstractAction2 implements SelectionObserver {
 ...
 private void updateEnablement() {
  ...
  setEnabled(mainFrame != null && m_selectionProvider != null && !Main
   .getInstance().isSessionRunning() && contents.isDataFlavorSupported(
    GeneralTransferHandler.CARDS_FLAVOR) || contents.isDataFlavorSupported(
    GeneralTransferHandler.CATEGORY_FLAVOR));
 }
