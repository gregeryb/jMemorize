...
public abstract class AbstractSessionDisabledAction extends AbstractAction2
 ...
 /*
  * (non-Javadoc) @see
  * jmemorize.core.LearnSessionObserver#sessionStarted(jmemorize.core.LearnSession)
  */
 ...
 /*
  * (non-Javadoc) @see
  * jmemorize.core.LearnSessionObserver#sessionEnded(jmemorize.core.LearnSession)
  */
 ...
 /**
  * This method is called when a session starts or ends. The implementation only
  * enables the action when there is currently no session running. Overwrite if
  * you want to define your own behavior.
  */
