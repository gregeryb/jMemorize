...
public class ImportCSVAction extends AbstractImportAction {
 ...
 public static Charset showCharsetChooser(JFrame owner) {
  ...
  String selection = (String) JOptionPane.showInputDialog(
   ...
   "UTF-8");
  /*
   * someone reported a bug (with stack tracke) where altough selection was
   * tested for null, before calling the method, a illegal-null-argument
   * exception was thrown - don't ask how this can be possible
   */
