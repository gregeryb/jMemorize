...
public class Card implements Events, Cloneable {
  ...
  * deck.
  *
  * @param frontside <code>true</code> if it should deliver the fronside value,
...
//      TODO move to CardSide class
 ...
 /**
  * Resets the amount of times that the card sides were learned in this deck to
  * 0.
  */
 ...
 /**
  * @return DateTouched is the date that this card was learned, skipped, reset
  * or created the last time. This value is used to sort cards by a global value
  * that is unique for all categories and decks.
  */
 ...
 public boolean isExpired() {
  ...
  return m_dateExpired != null && (m_dateExpired.before(now) || m_dateExpired
   .equals(now));
 }
  ...
  *
  * This includes the following data: Fronside, Flipside, Creation date. Setting
  * the right category needs to be handled from the out side.
  */
