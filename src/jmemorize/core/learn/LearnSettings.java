...
public class LearnSettings {
  ...
  * <code>false</code> if all cards should never be tested more then once in a
  * session.
  */
  ...
  * @return <code>true</code> if failed cards can appear more then once in a
  * session.
  */
  ...
  * <li>SIDES_RANDOM: show cards with randomly selected NORMAL or FLIPPED sides
  * mode.</li>
  * <li>SIDES_BOTH: show both sides of cards as specified in
  * {@link #setAmountToTest(boolean, int)}.</li>
  * </ul>
  *
  * @param mode either SIDES_NORMAL, SIDES_FLIPPED, SIDES_RANDOM or SIDES_BOTH;
  */
 ...
 /**
  * @return The current sides mode as given by enum SIDES_NORMAL, SIDES_FLIPPED
  * and SIDES_RANDOM.
  */
  ...
  * @param value The number of correct consecutive tests before it is declared
  * learnt
  */
 ...
 /**
  * The schedule tells how much time should pass before a cards that has moved
  * into a higher deck level needs be rechecked.
  *
  ...
  * <code>schedule[0] = 60</code> says that a card that has moved from deck 0 to
  * deck 1 should be rechecked in one hour. The time spans are given in minutes.
  */
  ...
  *
  * @param idx the index of the schedule preset. See {@link #SCHEDULE_PRESETS}
  */
  ...
  * @param currentLavel The deck level of the card before raising it to the next
  * level.
  */
 public Date getExpirationDate(Date learnDate, int currentLevel) {
  ...
  if (m_fixedExpirationTimeEnabled) {
   ...
   if (hour > m_fixedExpirationHour || (hour == m_fixedExpirationHour && minute
    >= m_fixedExpirationMinute)) {
 ...
 /**
  * This method sets the order by which categories will be shown when grouping
  * by categories is enabled.
  *
  ...
  *
  * @param idx the index of the preset schedule. See {@link #SCHEDULE_PRESETS}
