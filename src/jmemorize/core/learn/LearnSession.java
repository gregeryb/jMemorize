...
public interface LearnSession {
  ...
  * start automatically so that observers have the chance to attach themselves
  * before the first card is fetched.
  */
 ...
 /**
  * @return the date this session ended or <code>null</code> if it hasn't ended
  * yet.
  */
 public Date getEnd();
  ...
  *
  * @param passed <code>true</code> if the test was passed. <code>false</code>
  * if it failed.
  * @param shownFlipped <code>true</code> if the card was shown in flipped mode.
  * <code>false</code> if shown in regular mode.
  */
 ...
 /**
  * @return the list of all cards that were checked in this learn session until
  * now. The list only contains unique cards, that is if a card was checked more
  * then once, it appears at the position of its last check. A card is
  * considered checked, when it is shown. This is a list so that the cards can
  * be enumerated in the sequence they were shown.
  */
 public List<Card> getCheckedCards();

 /**
  * A card is passed when it came up in the session and was answered
  * successfully. It can't have been failed in the session before. Otherwise it
  * is called relearned (see {@link #getRelearnedCards()}.
  *
 ...
 /**
  * A card is partially passed when it came up in the session and was answered
  * successfully, but has not been fully learned yet.
  *
 ...
 /**
  * A card is failed when it wasn't unlearned at session start, came up in the
  * session and the user failed at answering it.
  *
  ...
  * this session. Otherwise it automatically falls into the the learned, failed
  * or relearned category.
  *
  * @return the list of all cards that have been skipped in this learn session
  * until now.
  */
  ...
  * <i>same</i> session.
  *
  * @return the list of all cards that have been relearned in this learn session
  * until now.
  */
 public Set<Card> getRelearnedCards();

 /**
  * @return <code>true</code> if this session should be considered relevant. A
  * session is relevant when at least one card was passed or failed.
  */
