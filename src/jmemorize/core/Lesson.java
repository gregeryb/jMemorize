...
public class Lesson implements CategoryObserver {
 ...
 /**
  * Returns a clone of this lesson. The clone contains all cards and categories
  * of the original lesson, but has all cards reset to have no learn stats.
  */
 ...
 /**
  * Sets a new root category and add this lesson as it's obvserver. RootCategory
  * must be <code>null</code> prior to calling this method, because lessons
  * don't support changes to the root category.
  *
