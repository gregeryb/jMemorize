...
public interface LessonProvider {
  ...
  *
  * This method fires a {@link LessonObserver#lessonClosed(Lesson)} if there was
  * an lesson loaded. This methods also fire
  ...
  * lesson.
  *
  * @param file Can't be null. Use setLesson(new Lesson()) if you want to set a
  * empty lesson.
  */
  ...
  * Saves the lesson.
  *
  * This method fires a {@link LessonObserver#lessonSaved(Lesson)} after having
  * saved the lesson.
  *
  * @param lesson the lesson that is to be saved. To save the currently opened
  * lesson, use <code>saveLesson(Main.getInstance().getLesson(), file)</code>.
  * @param file the file in which the lesson should be saved.
  * @throws IOException exception that is thrown when lesson couldn't be saved.
  */
 public abstract void saveLesson(Lesson lesson, File file) throws IOException;

 /**
  * @return currently loaded lesson. There can always only be at most one lesson
  * that is loaded. Returns <code>null</code> if there is no currently loaded
  * lesson.
  */
